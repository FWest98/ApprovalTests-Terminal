...
public class SnapshotRendererTests
{
    ...
    public Task Should_Render_Correctly(string scenario)
    {
        ...
        filesystem.CreateFile($"/input/{scenario}.approved.txt")
            .SetEmbedded($"ApprovalTests.Terminal.Tests/Data/{scenario}/old");
        filesystem.CreateFile($"/input/{scenario}.received.txt")
            .SetEmbedded($"ApprovalTests.Terminal.Tests/Data/{scenario}/new");
